...
::: {.big-code}
```bash
# O Bash ignora tudo depois do cerquilha
...
::: {.notes}
Digite uma linha iniciada por cerquilha. Tempo sugerido: 2 minutos.
:::
...
Visualize os alvos antes de combinar curinga e `rm`.

::: {.notes}
Teste os curingas e use printf para visualizar a expansão. Tempo sugerido: 4 minutos.
:::
